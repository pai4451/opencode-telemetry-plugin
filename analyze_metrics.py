...
Default path: /home/<username>/opencode/otel-data/metrics.jsonl
"""
...
Examples:
    ...
    parser.add_argument(
        "filepath",
        nargs="?",
        default="/home/<username>/opencode/otel-data/metrics.jsonl",
        help="Path to metrics.jsonl file (default: /home/<username>/opencode/otel-data/metrics.jsonl)"
    )
    parser.add_argument(
        "--to-mongo",
        action="store_true",

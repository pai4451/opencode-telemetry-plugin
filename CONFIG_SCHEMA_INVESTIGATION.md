...
**File:** `/home/<username>/opencode/packages/opencode/src/config/config.ts:1047`
...
**File:** `/home/<username>/opencode/packages/opencode/src/config/config.ts:1002-1044`
...
**File:** `/home/<username>/opencode/packages/sdk/js/src/gen/types.gen.ts`
...
**File:** `/home/<username>/opencode/packages/plugin/src/index.ts:150`
...
```typescript
// In /home/<username>/opencode/packages/opencode/src/config/config.ts
experimental: z
  .object({
    // ... existing fields ...
    openTelemetry: z.boolean().optional(),
